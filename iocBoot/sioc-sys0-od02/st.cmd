...
dbLoadRecords("db/bkh_odm_li00.db", "P=ODM:LI00,M=BKH01,LOC=L2KA01-08")
dbLoadRecords("db/bkh_odm_li01.db", "P=ODM:LI01,M=BKH02,LOC=L2KA01-08")
dbLoadRecords("db/bkh_odm_li02.db", "P=ODM:LI02,M=BKH03,LOC=L2KA02-09")
dbLoadRecords("db/bkh_odm_li03.db", "P=ODM:LI03,M=BKH04,LOC=L2KA03-07")
dbLoadRecords("db/bkh_odm_supervisor.db", "P=ODM:LI03:OD01,M=BKH05,LOC=L2KA03-07")
dbLoadRecords("db/bkh_odm_li04.db", "P=ODM:LI04,M=BKH06,LOC=L2KA04-06")
dbLoadRecords("db/bkh_odm_li05.db", "P=ODM:LI05,M=BKH07,LOC=L2KA05-07")
dbLoadRecords("db/bkh_odm_li06.db", "P=ODM:LI06,M=BKH08,LOC=L2KA06-08")
dbLoadRecords("db/bkh_odm_li07.db", "P=ODM:LI07,M=BKH09,LOC=L2KA07-03")
